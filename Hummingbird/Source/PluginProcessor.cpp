...
//==============================================================================
const juce::String HummingbirdAudioProcessor::getName() const
{
...
bool HummingbirdAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
const juce::String HummingbirdAudioProcessor::getProgramName (int index)
{
    return {};
}

void HummingbirdAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void HummingbirdAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* HummingbirdAudioProcessor::createEditor()
{
    return new HummingbirdAudioProcessorEditor (*this);
}

//==============================================================================
void HummingbirdAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
